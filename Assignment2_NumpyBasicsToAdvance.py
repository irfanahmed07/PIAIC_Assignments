...
def function1():
    ...
    x =np.arange(12).reshape((6,2))    # Write your code here 
    return x
"""
    expected output:
    [[ 1  2]
...
def function11():
    ...
    ans =ans=np.where(arr%2==1,-1,arr)   #write your code here 
    return ans
...
def function12():
    ...
    d=np.tile(arr,3)
    ans=np.concatenate((ans,d),axis=0)
    return ans
...
def function14():
    ...
    ans = arrange.reshape(8,3) #write your code here 
    ans=np.split(ans,4)
    return ans
